...
function init() {
  ...
  function createTriangle (triangleSize) {
    ...
    pointA = new THREE.Vector3(trianglePoints[1].x, trianglePoints[1].y, trianglePoints[1].z);
    pointB = new THREE.Vector3(trianglePoints[2].x, trianglePoints[2].y, trianglePoints[2].z);
    pointC = new THREE.Vector3(trianglePoints[3].x, trianglePoints[3].y, trianglePoints[3].z);  
